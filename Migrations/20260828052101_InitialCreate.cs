        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Venues_TotalCapacity", "[TotalCapacity] > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Events_DateTime", "[EndDateTime] > [StartDateTime]");
                    table.CheckConstraint("CK_Events_ParkingFee", "[ParkingFee] >= 0");
                    table.CheckConstraint("CK_Events_TicketPrice", "[TicketPrice] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ParkingSlots_Fee", "[Fee] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ParkingReservations_Fee", "[FeeAtReservation] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_BookingSeats_PriceAtBooking", "[PriceAtBooking] >= 0");
                    table.ForeignKey(
