...
namespace Event_and_parking_reservation_system.Repositories
{
    public class EventRepository : IEventRepository
    {
        ...
        public async Task<IEnumerable<Event>> GetAllAsync(EventFilterDto filter)
        {
        ...
        public async Task<int> GetBookedSeatCountAsync(int eventId)
        {
            return await _context.BookingSeats
                .CountAsync(bs => bs.Seat.EventId == eventId);
        }
    }
}